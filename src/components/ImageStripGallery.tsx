  ...
  return (
    <section className="py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row h-[600px] w-full gap-1 overflow-hidden">
            ...
            return (
              <motion.div
                ...
                <div className="absolute bottom-6 left-6 z-20">
                  ...
                  <p className="text-white font-display font-bold text-xl md:text-2xl opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 delay-150">
                    {item.title}
                  </p>
                </div>
              </motion.div>
